...
const WishDetails = ({ wish }) => {
  ...
  return (
    <article className="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-4 shadow-md shadow-slate-200/80 transition hover:-translate-y-1 hover:border-primary/40 hover:shadow-primary/30">
      <div className="absolute inset-x-10 -top-10 h-20 rounded-full bg-primary/10 blur-2xl opacity-0 transition group-hover:opacity-100" />
      <div className="relative space-y-2">
        ...
        <div className="mt-3 flex flex-wrap items-center gap-3 text-[11px] text-slate-500">
          ...
          <span className="inline-flex items-center gap-1 rounded-full bg-fuchsia-50 px-2.5 py-1">
            <span className="h-1 w-1 rounded-full bg-fuchsia-500" />
            {formatTime(wish.time)}
          </span>
          <span className="inline-flex items-center gap-1 truncate rounded-full bg-slate-100 px-2.5 py-1 max-w-[180px]">
